...
byoh install yo                             # renderiza a dist/ y luego --host lo activa
...
byoh install <slug> [--target <host>] [--host] [--force]  # renderiza árbol políglota a dist/; --host lo activa en cada host
