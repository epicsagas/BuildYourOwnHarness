...
| # | 문서 | 역할 | 분량 |
|---|------|------|------|
| 00 | [리서치 보고서](docs/00_RESEARCH_REPORT.md) | **근거**: 7개 프로젝트에서 17개 빌딩 블록(B1-B17) 추출 + 갭 분석 | 548줄 / 7 다이어그램 |
| 01 | [프로젝트 계획서](docs/01_PROJECT_PLAN.md) | **무엇을**: 비전·페르소나·가치제안·비즈니스모델·KPI·경쟁분석 | 448줄 / 7 다이어그램 |
| 02 | [아키텍처 설계서](docs/02_ARCHITECTURE.md) | **어떻게**: C4 컨테이너·3단계 취합 파이프라인·컴파일러·데이터모델 | 875줄 / 14 다이어그램 |
| 03 | [인터뷰 설계서](docs/03_INTERVIEW_DESIGN.md) | **차별 핵심**: 암묵지 발굴 루프·질문 뱅크·장르별 분기·프로파일 스키마 | 672줄 / 5 다이어그램 |
| 04 | [기술 로드맵](docs/04_ROADMAP.md) | **언제**: M0-M5 마일스톤·의존관계·평가게이트·기술부채 | 608줄 / 7 다이어그램 |
...
> **통계**: 총 3,151줄, 40개 mermaid 다이어그램, 17개 빌딩 블록 전수 인용. 작성일 2026-06-24.
