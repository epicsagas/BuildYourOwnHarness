# install.ps1 — one-line installer for byoh (Windows)
# Usage: irm https://github.com/epicsagas/BuildYourOwnHarness/releases/latest/download/install.ps1 | iex
param(
    [string]$InstallDir = "$env:USERPROFILE\.local\bin"
)

$Repo   = "epicsagas/BuildYourOwnHarness"
$Binary = "byoh"
...
$tmpdir = New-Item -ItemType Directory -Path (Join-Path $env:TEMP "byoh-install-$pid") -Force
